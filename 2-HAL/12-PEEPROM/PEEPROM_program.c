...
{
	DIO_u8SetPortValue(PEEPROM_ADDRESS_PORT, (u8)Copy_u16LocationAddress);
	DIO_u8SetPinValue(PEEPROM_CTRL_PORT, PEEPROM_A8, GET_BIT(Copy_u16LocationAddress, 8));
	DIO_u8SetPinValue(PEEPROM_CTRL_PORT, PEEPROM_A9, GET_BIT(Copy_u16LocationAddress, 9));
	DIO_u8SetPinValue(PEEPROM_CTRL_PORT, PEEPROM_A10, GET_BIT(Copy_u16LocationAddress,10));
